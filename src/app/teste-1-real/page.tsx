    ...
    <div style={{ minHeight: "100vh", background: "#f5f5f5", fontFamily: "Arial, sans-serif" }}>
      <header style={{ background: "white", borderBottom: "1px solid #e5e5e5", position: "sticky", top: 0, zIndex: 20 }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "14px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <span style={{ fontSize: 12, color: "#2e7d32", fontWeight: 700, display: "flex", alignItems: "center", gap: 6 }}>🔒 Pagamento teste • BravoPay • R$ 1,00</span>
        </div>
      </header>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "32px 16px" }}>
        ...
        <div style={{ background: "white", borderRadius: 16, border: "1px solid #eee", overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,0.06)" }}>
          <div style={{ padding: 24, display: "flex", gap: 20, flexWrap: "wrap", alignItems: "center" }}>
            ...
            <div style={{ flex: 1, minWidth: 240 }}>
              ...
              <p style={{ fontSize: 13, color: "#666", marginTop: 6, lineHeight: 1.5 }}>
                Valor real cobrado via BravoPay. Use para validar PIX e Cartão com custo mínimo. Também disponível em <Link href="/produto/produto-teste-1-real" style={{ color: "#4e008e", textDecoration: "underline" }}>/produto/produto-teste-1-real</Link>.
              </p>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginTop: 12 }}>
                <span style={{ fontSize: 28, fontWeight: 800, color: "#4e008e" }}>R$ 1,00</span>
                <span style={{ fontSize: 13, color: "#888" }}>no PIX • 1x de R$ 1,00 sem juros</span>
              </div>
              <p style={{ fontSize: 11, color: "#999", marginTop: 4 }}>ID: {TEST_PRODUCT.id} • 100 centavos • BravoPay {process.env.NEXT_PUBLIC_BASE_URL ? "" : ""}</p>
            </div>
          </div>
          ...
          <div style={{ padding: "16px 24px", background: "#fafafa", borderTop: "1px solid #eee", display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              <Link href="/produto/produto-teste-1-real" style={{ height: 40, borderRadius: 999, border: "1px solid #4e008e", background: "white", color: "#4e008e", fontWeight: 700, fontSize: 13, display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
                Ver como PDP
              </Link>
        ...
        <div style={{ marginTop: 16, background: "white", borderRadius: 12, border: "1px solid #eee", padding: 16 }}>
          ...
          <ol style={{ fontSize: 13, color: "#444", lineHeight: 1.7, paddingLeft: 18, display: "flex", flexDirection: "column", gap: 4 }}>
            <li>Clique em <b>Pagar R$ 1,00 agora</b></li>
            <li>Preencha <b>Nome e E-mail</b> (sem CPF/telefone)</li>
            <li>Escolha <b>PIX</b> (10% OFF) ou <b>Cartão</b> e confirme - o backend chama <code>POST /api/bravopay/create-transaction</code> com <code>amount_cents: 100</code></li>
